...
async function fetchAndPopulateDropdowns() {
  try {
    ...
    // KK Update for Stork app route change
    const response = await fetch('/stork-app/api/metadata');
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      // KK updated endpoint for stork-app
      const response = await fetch("/stork-app/api/cluster", {
        method: "POST",
