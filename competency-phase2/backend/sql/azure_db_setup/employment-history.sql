...
CREATE TABLE dbo.staging_employment_history (
    e_id INT NOT NULL,                -- FK to employee
    eh_company VARCHAR(100) NOT NULL,
    eh_location VARCHAR(100) NOT NULL,
    eh_role VARCHAR(50) NOT NULL,
    eh_start INT NOT NULL,
    eh_end INT NULL,                  -- NULL allowed
...
SELECT * FROM staging_employment_history;
...
BULK INSERT dbo.staging_employment_history
FROM 'employment-history.csv'
WITH (
...
SELECT
    ...
    eh_end,
    data_origin
FROM dbo.staging_employment_history;
...
SELECT COUNT(*) FROM dbo.staging_employment_history;
SELECT COUNT(*) FROM dbo.employment_history;
